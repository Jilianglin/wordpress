...
$jscomp.polyfill("Promise.allSettled",function(h){function n(g){return{status:"fulfilled",value:g}}function m(g){return{status:"rejected",reason:g}}return h?h:function(g){var l=this;g=Array.from(g,function(H){return l.resolve(H).then(n,m)});return l.all(g)}},"es_2020","es3");
(function(h,n,m,g,l,H){let e,ea,I,fa,Ba,pa,Ca,D,r=null,ha=null,Z=null,L=null,x=null,w=null,F=!1,ia=!1,T=!1,aa,u,ja,qa=!1,ba,U=!1,V=!1;const z=l.Utils.getMouseEvents(),ra=h.isTouch?z:{mousedown:"click"},N=function(a,b){l.hasChanged=!0;g.execCommand(a,!1,void 0!==b?b:null);X()},Fa=function(a){a=g.queryCommandState(a);return-1===a?!1:a},Q={formatBlock:{result(a){a=a.parentNode.classList.contains("tb_editor_selected")?"p":a.getAttribute("data-action");N("formatBlock","<"+a+">")},state(a){a=a.getElementsByClassName("tb_editor_options")[0].getElementsByClassName("tb_editor_action");
...
q.length-1;-1<B;--B)if(0===q[B].indexOf("wp-image-")){q.remove(q[B]);break}q.add("wp-image-"+p);if(F){aa=H.clone(e.closest(".active_module"));const J=g.createElement("div");p=e.hasAttribute("data-w")||e.hasAttribute("data-h");q=e.hasAttribute("data-w")?e.getAttribute("width"):!1;B=e.hasAttribute("data-h")?e.getAttribute("height"):!1;const Y=function(){U=!0;sa(!v);const C=e.closest(".active_module");C&&(e.hasAttribute("data-update")&&(C.innerHTML=C.innerHTML,e=C.getElementsByClassName("tb_selected_img")[0]),
l.Utils.runJs(n(C),"module"));h.trigger("tb_image_resize",e);ta();W();h.requestIdleCallback(function(){setTimeout(function(){requestAnimationFrame(W)},25)},500);J.remove()};J.className="tf_loader";x.appendChild(J);x.classList.add("tb_image_editor_loading");e.removeAttribute("srcset");!v&&p?(e.setAttribute("data-orig",f.url),e.setAttribute("data-ext",f.mime)):(e.removeAttribute("data-ext"),e.removeAttribute("data-orig"),v&&(e.alt=t,e.title=A));if(!p||v&&!q&&!B)e.width=f.width,e.height=f.height;!q&&
...
d),v.value!==q&&(v.value=q),a.querySelector(".tb_editor_lightbox_actions").classList.remove("tf_hide")))}a.addEventListener("focusout",Ha,{passive:!0});a.addEventListener("change",Ha,{passive:!0});a.querySelector("#tb_editor_link_type").addEventListener("change",function(A){this.closest("form").querySelector(".tb_editor_lightbox_actions").classList.toggle("tf_hide","lightbox"!==this.value);O();P();R(!0)},{passive:!0});L.appendChild(Ia());L.appendChild(a);r.classList.add("tf_hide","tb_editor_dialog_open",
...
function(f){f.stopPropagation();"tb_editor_dialog_content"!==g.activeElement.id&&L.contains(g.activeElement)||c(f.detail.val)},{passive:!0});k.addEventListener("change",function(f){f.stopPropagation();c(n(this).tfminicolors("rgbaString"))},{passive:!0});d.addEventListener("change",function(f){U=!0;f.stopPropagation();h.triggerEvent(k,"change")},{passive:!0});P();R(!0)}}},sa=function(a){if(e&&U){const B=l.Models.Registry.lookup(I),J=!(!l.activeModel||I!==l.activeModel.cid);if(B){var b=J?{}:B.get("mod_settings"),
...
d.closest(".active_module");if(k&&(I=k.getAttribute("data-cid"),(a=l.Models.Registry.lookup(I))&&void 0!==a.attributes.mod_settings.__dc__&&void 0!==a.attributes.mod_settings.__dc__[d.dataset.name]))return;U=!1;D=h.body[0].classList;ca();D.add("tb_editor_active");m.top.document.body.classList.add("tb_editor_active");V=!F&&d.hasAttribute("data-hasEditor");e=d;k&&(aa=H.clone(k),k.classList.add("tb_editor_on"),k.classList.remove("tb_editor_clicked"));a=e;c=d.closest("form");b=d.closest("[draggable]");
...
u.params.autoplay.enabled&&(u.el.dataset.stopped=!0,u.autoplay.stop(),u.params.thumbs&&u.params.thumbs.swiper.autoplay&&u.params.thumbs.swiper.autoplay.enabled&&(u.params.thumbs.swiper.el.dataset.stopped=!0,u.params.thumbs.swiper.autoplay.stop()));F?(D.add("tb_editor_image_active"),m.top.document.body.classList.add("tb_editor_image_active"),h.on("tfsmartresize",W).on("tbresizeImageEditor",W)):(ja=V?e.innerHTML:e.textContent,e.contentEditable=!0,e.focus(),e.addEventListener("blur",E,{passive:!0}),
e.addEventListener("input",X,{passive:!0}),e.addEventListener("change",X,{passive:!0}),h.isTouch||setTimeout(function(){k&&k.addEventListener("dblclick",ua,{passive:!0})},800),ea=l.undoManager.stack,l.undoManager.reset());h.on("tbDisableInline",E);g.addEventListener(z.mousedown,E,{passive:!0});m.top.document.addEventListener(z.mousedown,E,{passive:!0});setTimeout(function(){H.Lightbox.$lightbox.one("themify_opened_lightbox",La)},600);V?(g.addEventListener("selectionchange",Ma,{passive:!0}),Va(),P(),
r.addEventListener(ra.mousedown,Na),Z=r.querySelector("#tb_editor_link_value"),L=r.querySelector("#tb_editor_dialog")):F&&(d.closest(".masonry")?h.requestIdleCallback(function(){setTimeout(function(){requestAnimationFrame(function(){Ea(d)})},25)},500):Ea(d))}}})},P=function(){const a=r.className;var b=r.classList;b.add("tf_hidden");b.remove("tf_hide");b=r.getBoundingClientRect();fa=b.width+40;Ba=b.height+30;r.className=a},ka=function(){const a=m.getSelection();w=!1===a.isCollapsed?a.getRangeAt(0).cloneRange():
...
"expand"!==a?(void 0!==Q[a]&&void 0!==Q[a].result?Q[a].result(b):(O(),N(a)),Pa()):!b.classList.contains("tb_editor_disable")&&(b=l.Models.Registry.lookup(I))&&(E(),m.getSelection().removeAllRanges(),b.trigger("edit",null)),T=!1)},X=function(a){a&&a.stopPropagation();if(e){U=!0;const b=V?e.innerHTML:e.textContent;if(ja!==b||F)l.hasChanged=!0,l.activeModel&&l.activeModel.cid===I&&sa(),a&&"input"!==a.type||l.undoManager.push(I,ja,b,"inline",e),ja=b}},Ha=function(a){a.stopPropagation();if(!("focusout"===
...
e&&Ea(e)})},ta=function(){null!==u&&u.update()},Da=function(){x&&(x.removeEventListener(z.mousedown,Qa,{passive:!0}),x.removeEventListener("dblclick",ua,{passive:!0}),x.remove(),x=null)},E=function(a){if(!qa){var b=null;if(a&&(b="blur"===a.type?a.relatedTarget?a.relatedTarget:H.Lightbox.$lightbox[0].contains(m.top.document.activeElement)?m.top.document.activeElement:g.activeElement:a.target,!F&&b.closest(".tb_toolbar_undo"))){e&&e.removeEventListener("blur",E,{passive:!0});setTimeout(function(){e&&
e.addEventListener("blur",E,{passive:!0});w=null;la();e&&e.focus();R()},120);return}if(!a||"blur"===a.type||1===a.which)if(!a||!r||(a.touches||"blur"===a.type||1===a.which)&&r!==b&&!r.contains(b)){let k=e&&l.Instances.Builder[l.builderIndex].el.contains(e)?e.closest(".module"):l.Instances.Builder[l.builderIndex].el.querySelector(".tb_element_cid_"+I+" .module");la();if(a&&k&&(k===b||k.contains(b)))a&&"blur"!==a.type&&e&&!1===m.getSelection().isCollapsed&&(D.contains("tb_editor_start_select")||(m.top.document.body.classList.add("tb_editor_start_select"),
D.add("tb_editor_start_select")),this.addEventListener(z.mouseup,ca,{passive:!0,once:!0}));else{g.removeEventListener(z.mousedown,E,{passive:!0});g.removeEventListener("selectionchange",Ma,{passive:!0});g.removeEventListener(z.mouseup,ca,{passive:!0,once:!0});m.top.document.removeEventListener(z.mousedown,E,{passive:!0});H.Lightbox.$lightbox.off("themify_opened_lightbox",La);ca();ea&&(l.undoManager.stack=ea,l.undoManager.index=ea.length-1,l.undoManager.updateUndoBtns());if(e){e.removeEventListener("input",
...
(k.classList.remove("tb_editor_on","tb_editor_clicked"),k.removeEventListener("dblclick",ua,{passive:!0}),U&&(sa(),e.hasAttribute("data-no-update")||l.Utils.runJs(n(k),"module")));l.ActionBar.hoverCid=aa=r=D=V=w=fa=Ba=pa=ha=L=Z=I=ea=ja=u=e=null}}}};if(h.is_builder_loaded)Oa();else h.on("tb_css_visual_modules_load",Oa,!0);h.on("undo",function(a,b,c,d){"inline"!==b&&E()}).on("disableInline",function(){E()})})(Themify,jQuery,window,document,tb_app,ThemifyBuilderCommon);
