...
this.swatchesHTML=function(){const a=h.createDocumentFragment(),b=h.createElement("div"),c=h.createElement("ul"),d=themifyColorManager.makeImportExportDropdown(),f=h.createElement("a");f.className="tb_gradient_add_swatch tf_plus_icon";let e=h.createElement("span");e.className="themify_tooltip";e.innerText=ThemifyConstructor.label.save_gradient;f.appendChild(e);f.href="#";f.addEventListener("click",this.saveSwatch.bind(this));b.className="tb_cm_dropdown_icon";b.tabIndex=1;e=h.createElement("span");
