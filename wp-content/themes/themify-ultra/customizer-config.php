...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_general_acc' => $themify_customizer->accordion_start( __( 'General', 'themify' ) ),

		'end_general_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------*/

		'tooltip_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Tooltips', 'themify' ),
				'color_label' => __( 'Background Color', 'themify' ),
			),
			'selector' => 'body .tf_tooltip_content, body .tf_tooltip_content:before',
			'prop' => 'background-color',
		),
		'tooltip_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Tooltip Font', 'themify' ),
				'show_label' => false,
			),
			'selector' => 'body .tf_tooltip_content',
			'prop' => 'font',
		),
		'tooltip_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Tooltip Text Color', 'themify' ),
				'show_label' => false,
			),
			'selector' => 'body .tf_tooltip_content',
			'prop' => 'color',
